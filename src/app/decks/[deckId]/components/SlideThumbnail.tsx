...
const SlideThumbnail: React.FC<SlideThumbnailProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h4 className="font-semibold text-center mb-1 text-xs sm:text-sm text-white">
          {slide.title}
        </h4>
        <p className="truncate text-center text-xs leading-tight hidden sm:block text-gray-300">
